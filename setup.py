...
setup(
    ...
    #
    # And where it will live on PyPI: https://pypi.org/project/aced_queries/
    #
    # There are some restrictions on what makes a valid project name
    # specification here:
    # https://packaging.python.org/specifications/core-metadata/#name
    name='aced_queries',  # Required
    ...
    description='Download Medable objects',
    # Optional
    ...
    url='https://source.ohsu.edu/HOP/data-etl',  # Optional
    ...
    # entry_points={
    #     'console_scripts': [
    #         'aced_queries = aced_queries.etl_cli:cli'
    #     ],
    # },
    ...
    project_urls={  # Optional
        'Bug Reports': 'https://github.com/ACED-IDP/aced_queries/issues',
        'Source': 'https://github.com/ACED-IDP/aced_queries',
    },
)
